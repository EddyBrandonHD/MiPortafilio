...
if( !$error ) {
	mail("xbox-eddy2012@hotmail.com", $subject, $mensaje, $from);
}
?>
...
<head>
	<meta charset="utf-8">
	<title>Brandon Eduardo Villanueva Barboza / Developer Full Stack</title>
...
<body>
		...
		<article class="single-page">
			...
			<header class="page-header">
				<div class="container">
					...
					<p>Contactame para la elaboracion de algun proyecto y asi yo poderme poner en concacto contigo. </p>
	...
	<footer id="main-footer">
		...
		<div id="bottom-footer" class="container cf">
			...
			<div class="copyright">
						&copy; <a href="www.linkedin.com/in/eddybrandonhd">Brxndyy</a>
			</div><!-- /.copyright -->
